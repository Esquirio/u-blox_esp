...
void wifi_init_sta(void) {
    ...
    ESP_ERROR_CHECK(esp_wifi_set_max_tx_power(tx_power_set));

    ESP_ERROR_CHECK(esp_wifi_get_max_tx_power(&tx_power_get));
    ESP_LOGI(TAG_WIFI_STA, "Wifi tx power level is %d.", tx_power_get);
